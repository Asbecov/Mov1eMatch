...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _838: (x0,x1,x2) => x0.supports(x1,x2),
      _839: () => globalThis.CSS,
      ...
      _1273: x0 => x0.send(),
      _1274: () => new XMLHttpRequest(),
      _1275: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1276: (x0,x1) => x0.querySelector(x1),
      _1277: (x0,x1) => x0.append(x1),
      _1278: x0 => x0.remove(),
      _1279: (x0,x1) => x0.getAttribute(x1),
      _1280: () => globalThis.removeSplashFromWeb(),
      _1281: Date.now,
      _1283: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1284: s => {
      ...
      _1286: () => typeof dartUseDateNowForTicks !== "undefined",
      _1287: () => 1000 * performance.now(),
      _1288: () => Date.now(),
      _1289: () => {
      ...
      _1291: () => new WeakMap(),
      _1292: (map, o) => map.get(o),
      _1293: (map, o, v) => map.set(o, v),
      _1294: x0 => new WeakRef(x0),
      _1295: x0 => x0.deref(),
      _1301: () => globalThis.WeakRef,
      _1306: s => JSON.stringify(s),
      _1307: s => printToConsole(s),
      _1308: (o, p, r) => o.replaceAll(p, () => r),
      _1309: (o, p, r) => o.replace(p, () => r),
      _1310: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1311: s => s.toUpperCase(),
      _1312: s => s.trim(),
      _1313: s => s.trimLeft(),
      _1314: s => s.trimRight(),
      _1315: (string, times) => string.repeat(times),
      _1316: Function.prototype.call.bind(String.prototype.indexOf),
      _1317: (s, p, i) => s.lastIndexOf(p, i),
      _1318: (string, token) => string.split(token),
      _1319: Object.is,
      _1320: (a, i) => a.push(i),
      _1324: a => a.pop(),
      _1325: (a, i) => a.splice(i, 1),
      _1326: (a, s) => a.join(s),
      _1327: (a, s, e) => a.slice(s, e),
      _1329: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1330: a => a.length,
      _1332: (a, i) => a[i],
      _1333: (a, i, v) => a[i] = v,
      _1335: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1336: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1337: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1338: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1339: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1340: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1341: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1342: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1344: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1345: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1346: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1347: (t, s) => t.set(s),
      _1349: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1351: o => o.buffer,
      _1352: o => o.byteOffset,
      _1353: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1354: (b, o) => new DataView(b, o),
      _1355: (b, o, l) => new DataView(b, o, l),
      _1356: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1357: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1358: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1359: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1360: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1361: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1362: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1363: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1364: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1365: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1366: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1367: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1370: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1371: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1372: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1373: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1374: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1375: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1398: () => Date.now(),
      _1404: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1405: (x0,x1,x2) => x0.fetch(x1,x2),
      _1406: (x0,x1) => x0.get(x1),
      _1407: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1407(f,arguments.length,x0,x1,x2) }),
      _1408: (x0,x1) => x0.forEach(x1),
      _1410: () => new AbortController(),
      _1411: x0 => x0.getReader(),
      _1412: x0 => x0.read(),
      _1413: x0 => x0.cancel(),
      _1420: (x0,x1) => x0.createElement(x1),
      ...
      _1424: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1425: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1443: (s, m) => {
        try {
      ...
      _1444: (x0,x1) => x0.exec(x1),
      _1445: (x0,x1) => x0.test(x1),
      _1446: x0 => x0.pop(),
      _1448: o => o === undefined,
      _1450: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1452: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1453: o => o instanceof RegExp,
      _1454: (l, r) => l === r,
      _1455: o => o,
      _1456: o => o,
      _1457: o => o,
      ...
      _1459: o => o.length,
      _1461: (o, i) => o[i],
      _1462: f => f.dartFunction,
      _1463: () => ({}),
      _1464: () => [],
      _1466: () => globalThis,
      _1467: (constructor, args) => {
      ...
      _1469: (o, p) => o[p],
      _1470: (o, p, v) => o[p] = v,
      _1471: (o, m, a) => o[m].apply(o, a),
      _1473: o => String(o),
      _1474: (p, s, f) => p.then(s, f),
      _1475: o => {
      ...
      _1476: o => [o],
      _1477: (o0, o1) => [o0, o1],
      _1478: (o0, o1, o2) => [o0, o1, o2],
      _1479: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      _1480: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1494: x0 => x0.groups,
      _1495: x0 => x0.flags,
      _1496: x0 => x0.multiline,
      _1497: x0 => x0.ignoreCase,
      _1498: x0 => x0.unicode,
      _1499: x0 => x0.dotAll,
      _1500: (x0,x1) => x0.lastIndex = x1,
      _1501: (o, p) => p in o,
      _1502: (o, p) => o[p],
      _1505: x0 => x0.random(),
      _1508: () => globalThis.Math,
      _1509: Function.prototype.call.bind(Number.prototype.toString),
      _1510: Function.prototype.call.bind(BigInt.prototype.toString),
      _1511: Function.prototype.call.bind(Number.prototype.toString),
      _1512: (d, digits) => d.toFixed(digits),
      _1516: () => globalThis.document,
      _1537: (x0,x1) => x0.src = x1,
      _1538: x0 => x0.naturalWidth,
      _1539: x0 => x0.naturalHeight,
      _1555: x0 => x0.status,
      _1556: (x0,x1) => x0.responseType = x1,
      _1558: x0 => x0.response,
      _1900: (x0,x1) => x0.href = x1,
      _2922: (x0,x1) => x0.src = x1,
      _2928: (x0,x1) => x0.async = x1,
      _3391: () => globalThis.window,
      _5994: x0 => x0.signal,
      _6068: () => globalThis.document,
      _6150: x0 => x0.body,
      _6484: (x0,x1) => x0.id = x1,
      _6507: x0 => x0.innerHTML,
      _6508: (x0,x1) => x0.innerHTML = x1,
      _7830: x0 => x0.value,
      _7832: x0 => x0.done,
      _8534: x0 => x0.url,
      _8536: x0 => x0.status,
...
"error",
"showToast",
"The fluttertoast plugin for web doesn't implement ",
"the method '",
"Unimplemented",
"PlatformException(",
"BQ==",
...
"sessionId",
"votes",
"No deserialization found for type ",
...
"^[0-9a-f]{8}-[0-9a-f]{4}-[0-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$",
"^[0-9a-f]{8}-?[0-9a-f]{4}-?[0-8][0-9a-f]{3}-?[0-9a-f]{4}-?[0-9a-f]{12}$",
"^[0-9a-f]{8}-[0-9a-f]{4}-[0-8][0-9a-f]{3}-[0-9a-f]{4}-[0-9a-f]{12}$",
"` is an invalid ValidationMode.",
"Namespace.",
"ValidationMode.",
...
"Uri",
"BigInt",
"No deserialization found for type named ",
...
"There is no GoRouterState above the current context. This method should only be called under the sub tree of a RouteBase.builder.",
"GoError: ",
"assets/logo.svg",
"body",
"appBar",
...
"ToastGravity.",
"Toast.",
"Добавить фильм с названием: ",
"http://thumbs.dfs.ivi.ru/",
"https://moviematch.servehttp.com/images/",
"FlexFit.",
"noRepeat",
"ImageRepeat.",
"BoxFit.",
...
"assets/number_one.svg",
"assets/number_two.svg",
"assets/number_three.svg",
"Что-то пошло не так",
"animationController",
"going to ",
"queryParameters",
...
"startVotingSession",
"pool",
"Просканируйте QR код для голосования на телефоне:",
"https://asbecov.github.io/Mov1eMatch/",
"/voting/:votingId",
...
"_calcVersion",
"alert",
"Пока не получится закончить голосование",
"Поиск",
"Дальше",
...
"https://moviematch.servehttp.com/",
"IQ==",
